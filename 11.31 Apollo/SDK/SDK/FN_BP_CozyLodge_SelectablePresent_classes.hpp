...
public:
	...
	uint8                                        Pad_4E3A[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	struct FRandomStream                         NewVar_0;                                          // 0x4F4(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor)
	uint8                                        Pad_4E3B[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_4E3C[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_4E3D[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BP_CozyLodge_SelectablePresent_C");
		return Clss;
	}
