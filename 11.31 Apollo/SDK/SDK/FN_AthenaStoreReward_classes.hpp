...
public:
	...
	uint8                                        Pad_64C7[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_64C8[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	{
		static class UClass* Clss = UObject::FindClassFast("AthenaStoreReward_C");
		return Clss;
	}
	...
	void ViewItem();
	void BP_OnClicked();
	void ExecuteUbergraph_AthenaStoreReward(int32 EntryPoint, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
};
