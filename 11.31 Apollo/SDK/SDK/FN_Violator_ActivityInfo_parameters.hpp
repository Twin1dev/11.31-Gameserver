...
struct UViolator_ActivityInfo_C_HandleStyling_TextCallout_Params
{
public:
	bool                                         Is_Large_Display;                                  // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6253[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
...
struct UViolator_ActivityInfo_C_HandleStyling_Timer_Params
{
public:
	bool                                         Is_Large_Display;                                  // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6254[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	float                                        CallFunc_MakeLiteralFloat_ReturnValue;             // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_MakeLiteralFloat_ReturnValue_1;           // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UViolator_ActivityInfo_C_Construct_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_6255[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
