...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("FrontendChallengeInfoPanelEntry_C");
		return Clss;
	}

	void OnChallengeInfoSet();
	void OnLocalPlayerMissingAssistedChallenge();
	void ExecuteUbergraph_FrontendChallengeInfoPanelEntry(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
