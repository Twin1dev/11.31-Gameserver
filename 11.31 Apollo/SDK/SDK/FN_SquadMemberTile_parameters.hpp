...
public:
	...
	uint8                                        Pad_66A2[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FAthenaTeamDisplayInfo                CallFunc_GetSquadDisplayInfo_ReturnValue;          // 0x20(0x88)(None)
	class UTexture*                              K2Node_DynamicCast_AsTexture;                      // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xB0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsCurrentMemberLocal_ReturnValue;         // 0xB1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_Event_IsDesignTime;                         // 0xB2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EGameReadiness                    K2Node_Event_ReadyStatus;                          // 0xB3(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_Event_bHasValidMember;                      // 0xE8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         K2Node_Event_bIsInFrontend;                        // 0xFC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsCurrentMemberInFrontend_ReturnValue;    // 0xFD(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
