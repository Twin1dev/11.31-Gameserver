...
class UItemShopOfferRMT_C : public UFortRealMoneyOffer
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ItemShopOfferRMT_C");
		return Clss;
	}
	...
	void OnOfferSet();
	void ExecuteUbergraph_ItemShopOfferRMT(int32 EntryPoint, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, enum class EFortMtxOfferDisplaySize CallFunc_GetOfferDisplaySize_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationReverse_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, bool K2Node_Event_IsDesignTime);
