...
// class FText                        CallFunc_GetSTWConfirmationDialogText_OutTitle                   (None)
// class FText                        CallFunc_GetSTWConfirmationDialogText_OutDescription             (None)
// bool                               CallFunc_GetSTWConfirmationDialogText_bOutIsInParty              (ZeroConstructor, IsPlainOldData, NoDestructor)

void ULeaveButton_C::ShowLeaveScreen(class UUserWidget* CallFunc_GetCachedWidget_ReturnValue, class ULeaveDialog_C* K2Node_DynamicCast_AsLeave_Dialog, bool K2Node_DynamicCast_bSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, bool CallFunc_IsInNeighborhood_bIsInNeighborhood, class FText CallFunc_GetSTWConfirmationDialogText_OutTitle, class FText CallFunc_GetSTWConfirmationDialogText_OutDescription, bool CallFunc_GetSTWConfirmationDialogText_bOutIsInParty)
{
	static class UFunction* Func = nullptr;
...
// class UFortGlobalUIContext*        CallFunc_GetContext_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortOutpostContext*         CallFunc_GetContext_ReturnValue_1                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class APlayerController*           CallFunc_GetOwningPlayer_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortPlayerControllerOutpost*K2Node_DynamicCast_AsFort_Player_Controller_Outpost              (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_IsConsideredInGame_InGame                               (ZeroConstructor, IsPlainOldData, NoDestructor)
...
// class FText                        CallFunc_GetBRConfirmationDialogText_TitleText                   (None)
// class FText                        CallFunc_GetBRConfirmationDialogText_MessagText                  (None)
...
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// class FText                        CallFunc_GetSTWOutpostConfirmationDialogText_OutTitle            (None)
// class FText                        CallFunc_GetSTWOutpostConfirmationDialogText_OutDescription      (None)
...
// Function LeaveButton.LeaveButton_C.LeaveDialogCancelled__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void ULeaveButton_C::LeaveDialogCancelled__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LeaveButton_C", "LeaveDialogCancelled__DelegateSignature");
