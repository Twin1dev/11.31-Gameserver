...
public:
	...
	class UTexture2D*                            Game_TextureMinus_Water_Velocity_and_Height;       // 0x228(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
