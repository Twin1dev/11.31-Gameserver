...
public:
	...
	uint8                                        Pad_4F5D[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable_1;                            // 0x70(0x28)(None)
	...
	uint8                                        Pad_4F63[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectSpecHandle             CallFunc_SetupGE_Effect_Out;                       // 0x1D0(0x10)(None)
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x240(0x28)(None)
