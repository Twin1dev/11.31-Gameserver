...
public:
	...
	uint8                                        Pad_5717[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	struct FGameplayTagContainer                 CallFunc_K2_CanActivateAbility_RelevantTags;       // 0x68(0x20)()
	bool                                         CallFunc_K2_CanActivateAbility_ReturnValue;        // 0x88(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5718[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5719[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_571A[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	struct FEvaluationResult                     CallFunc_CanSpawnActorOfClass_ReturnValue;         // 0xC8(0x30)()
};
