...
// struct FGameplayEffectSpecHandle   CallFunc_AddGrantedTag_ReturnValue                               ()
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FGameplayEffectSpecHandle   CallFunc_AddGrantedTag_ReturnValue_1                             ()
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "Setup Effect Data");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "ShouldAffectTarget");
...
// struct FGameplayEffectSpecHandle   CallFunc_Setup_Effect_Data_Spec_Handle                           ()
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "ApplyEffects");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "GetAbilitySystemComponentAndPawn");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "UserConstructionScript");

	Params::ADevice_Floor_NoWeaponZone_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "UpdateVolumeSize");

	Params::ADevice_Floor_NoWeaponZone_C_UpdateVolumeSize_Params Parms;
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "UpdateMinigameVisuals");

	Params::ADevice_Floor_NoWeaponZone_C_UpdateMinigameVisuals_Params Parms;
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "BndEvt__Trigger_K2Node_ComponentBoundEvent_2_ComponentBeginOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "BndEvt__Trigger_K2Node_ComponentBoundEvent_3_ComponentEndOverlapSignature__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "PlayFX");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "OnAbilitySystemComponentInitialized");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "OnPlayerEmoteEnded");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "OnPlayerEmoteStarted");
...
{
	static auto Func = Class->GetFunction("Device_Floor_NoWeaponZone_C", "ExecuteUbergraph_Device_Floor_NoWeaponZone");
