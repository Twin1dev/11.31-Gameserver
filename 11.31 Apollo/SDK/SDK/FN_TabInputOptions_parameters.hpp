...
public:
	...
	class FText                                  CallFunc_GetBoundKeyNameBP_ReturnValue;            // 0x10(0x18)(None)
	class FText                                  CallFunc_GetBoundKeyNameBP_ReturnValue_1;          // 0x28(0x18)(None)
	class FText                                  CallFunc_GetInputDisplayTextBP_ReturnValue;        // 0x40(0x18)(None)
};
...
public:
	...
	uint8                                        Pad_529E[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
