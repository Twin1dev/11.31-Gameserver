...
{
public:
	uint8                                        Pad_1814[0xC];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	uint8                                        BitPad_165 : 1;                                    // Fixing Bit-Field Size  [ Dumper-8 ]
	uint8                                        bIsNetDirty : 1;                                   // Mask: 0x2, PropSize: 0x10xBC(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        BitPad_166 : 6;                                    // Fixing Bit-Field Size  [ Dumper-8 ]
	uint8                                        Pad_1815[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1816[0x10];                                    // Fixing Size After Last Property  [ Dumper-8 ]
...
{
public:
	uint8                                        Pad_1817[0x8];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1818[0x2];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1819[0x25];                                    // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1820[0x18];                                    // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1821[0x10];                                    // Fixing Size Of Struct [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1823[0x8];                                     // Fixing Size Of Struct [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1824[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1825[0x7];                                     // Fixing Size Of Struct [ Dumper-8 ]
