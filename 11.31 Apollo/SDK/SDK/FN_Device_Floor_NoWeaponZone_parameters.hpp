...
public:
	...
	struct FGameplayEffectSpecHandle             CallFunc_AddGrantedTag_ReturnValue;                // 0x38(0x10)(None)
	...
	struct FGameplayEffectSpecHandle             CallFunc_AddGrantedTag_ReturnValue_1;              // 0x50(0x10)(None)
...
public:
	...
	struct FGameplayEffectSpecHandle             CallFunc_Setup_Effect_Data_Spec_Handle;            // 0x80(0x10)(None)
	...
	struct FGameplayTagContainer                 CallFunc_MakeLiteralGameplayTagContainer_ReturnValue; // 0xA8(0x20)(None)
};
...
public:
	...
	uint8                                        Pad_5EEF[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5EF3[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
