...
public:
	...
	uint8                                        Pad_1751[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TMap<class FName, struct FCustomizedToolMenuEntry> Entries;                                           // 0x8(0x50)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FCustomizedToolMenuSection> Sections;                                          // 0x58(0x50)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FCustomizedToolMenuNameArray> EntryOrder;                                        // 0xA8(0x50)(ZeroConstructor, NativeAccessSpecifierPublic)
