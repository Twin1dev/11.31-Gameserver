...
public:
	...
	class FText                                  Temp_text_Variable_17;                             // 0x1D0(0x18)(None)
	class FText                                  Temp_text_Variable_18;                             // 0x1E8(0x18)(None)
	class FText                                  Temp_text_Variable_19;                             // 0x200(0x18)(None)
	class FText                                  Temp_text_Variable_20;                             // 0x218(0x18)(None)
	class FText                                  Temp_text_Variable_21;                             // 0x230(0x18)(None)
	class FText                                  Temp_text_Variable_22;                             // 0x248(0x18)(None)
	class FText                                  Temp_text_Variable_23;                             // 0x260(0x18)(None)
	class FText                                  Temp_text_Variable_24;                             // 0x278(0x18)(None)
	class FText                                  Temp_text_Variable_25;                             // 0x290(0x18)(None)
	class FText                                  Temp_text_Variable_26;                             // 0x2A8(0x18)(None)
	class FText                                  Temp_text_Variable_27;                             // 0x2C0(0x18)(None)
	class FText                                  Temp_text_Variable_28;                             // 0x2D8(0x18)(None)
	class FText                                  Temp_text_Variable_29;                             // 0x2F0(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue_1;             // 0x478(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_1;                           // 0x498(0x18)(None)
	struct FFormatArgumentData                   K2Node_MakeStruct_FormatArgumentData_2;            // 0x4B0(0x40)(HasGetValueTypeHash)
	class FText                                  K2Node_Select_Default_2;                           // 0x4F0(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_3;                           // 0x570(0x18)(None)
	class FText                                  K2Node_Select_Default_4;                           // 0x588(0x18)(None)
...
public:
	...
	bool                                         CallFunc_IsWorldCupQualifierEvent_ReturnValue;     // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	enum class EFortEventWindowEligibility       Temp_byte_Variable_2;                              // 0x8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         K2Node_Event_IsDesignTime;                         // 0xE(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FText                                  CallFunc_TextToUpper_ReturnValue_2;                // 0x90(0x18)(None)
	...
	enum class EFortEventWindowEligibility       CallFunc_GetTournamentEligibility_ReturnValue;     // 0xA9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ESlateVisibility                  K2Node_Select_Default_1;                           // 0xAA(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2F7E[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UWidget*                               K2Node_Select_Default_2;                           // 0xB0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
