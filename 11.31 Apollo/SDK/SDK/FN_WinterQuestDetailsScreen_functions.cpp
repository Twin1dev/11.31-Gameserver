...
{
	static auto Func = Class->GetFunction("WinterQuestDetailsScreen_C", "OnSetRewardsVaultRotator");
...
{
	static auto Func = Class->GetFunction("WinterQuestDetailsScreen_C", "OnResetVaultRotator");
...
{
	static auto Func = Class->GetFunction("WinterQuestDetailsScreen_C", "ExecuteUbergraph_WinterQuestDetailsScreen");
