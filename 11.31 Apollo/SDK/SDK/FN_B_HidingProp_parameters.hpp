...
public:
	...
	uint8                                        Pad_277A[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_277C[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_1;             // 0xE0(0xB0)(None)
	...
	uint8                                        Pad_27FD[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x3C8(0x18)(None)
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_3;             // 0x598(0xB0)(None)
	TArray<struct FGameplayTag>                  K2Node_MakeArray_Array;                            // 0x648(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue; // 0x658(0x20)(None)
	...
	struct FGameplayTagContainer                 CallFunc_MakeGameplayTagContainerFromArray_ReturnValue_1; // 0x698(0x20)(None)
	...
	uint8                                        Pad_2813[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
