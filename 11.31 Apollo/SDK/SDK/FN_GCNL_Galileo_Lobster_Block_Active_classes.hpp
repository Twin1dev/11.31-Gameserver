...
// 0x10 (0x798 - 0x788)
// BlueprintGeneratedClass GCNL_Galileo_Lobster_Block_Active.GCNL_Galileo_Lobster_Block_Active_C
class AGCNL_Galileo_Lobster_Block_Active_C : public AFortGameplayCueNotify_Loop
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GCNL_Galileo_Lobster_Block_Active_C");
		return Clss;
	}
