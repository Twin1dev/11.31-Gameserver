...
class UClass* ABP_Pawn_FrenchYedoc_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Pawn_FrenchYedoc_C");

	return Clss;
}


// BP_Pawn_FrenchYedoc_C BP_Pawn_FrenchYedoc.Default__BP_Pawn_FrenchYedoc_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Pawn_FrenchYedoc_C* ABP_Pawn_FrenchYedoc_C::GetDefaultObj()
{
	static class ABP_Pawn_FrenchYedoc_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Pawn_FrenchYedoc_C*>(ABP_Pawn_FrenchYedoc_C::StaticClass()->DefaultObject);
