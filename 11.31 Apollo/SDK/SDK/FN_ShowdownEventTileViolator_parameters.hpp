...
struct UShowdownEventTileViolator_C_RefreshViolatorData_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_6556[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	enum class EFortShowdownEventState           CallFunc_GetEventTimeState_ReturnValue;            // 0x3B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x3C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6557[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	class FText                                  CallFunc_GetWindowRoundDisplayString_ReturnValue;  // 0x40(0x18)()
	class FText                                  CallFunc_TextToUpper_ReturnValue;                  // 0x58(0x18)()
	bool                                         CallFunc_DoDisplayRoundNumber_ReturnValue;         // 0x70(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6558[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	int32                                        K2Node_Select_Default_1;                           // 0x74(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        K2Node_Select_Default_2;                           // 0x78(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
