...
public:
	...
	struct FGameplayEventData                    K2Node_CustomEvent_Payload;                        // 0x38(0xB0)(None)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0xE8(0x10)(ZeroConstructor, NoDestructor)
	struct FGameplayEventData                    Temp_struct_Variable_2;                            // 0xF8(0xB0)(None)
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x258(0x28)(None)
	...
	uint8                                        Pad_6286[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6288[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
