...
class UGCN_BattleLab_GenericObject_EnterWater_C : public UFortGameplayCueNotify_Burst
{
public:
	class USoundBase*                            Sound_to_Play;                                     // 0x1B0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
