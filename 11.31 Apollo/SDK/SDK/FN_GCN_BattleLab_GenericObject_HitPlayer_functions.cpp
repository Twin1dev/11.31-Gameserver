...
class UClass* UGCN_BattleLab_GenericObject_HitPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_BattleLab_GenericObject_HitPlayer_C");

	return Clss;
}


// GCN_BattleLab_GenericObject_HitPlayer_C GCN_BattleLab_GenericObject_HitPlayer.Default__GCN_BattleLab_GenericObject_HitPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_BattleLab_GenericObject_HitPlayer_C* UGCN_BattleLab_GenericObject_HitPlayer_C::GetDefaultObj()
{
	static class UGCN_BattleLab_GenericObject_HitPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_BattleLab_GenericObject_HitPlayer_C*>(UGCN_BattleLab_GenericObject_HitPlayer_C::StaticClass()->DefaultObject);
...
void UGCN_BattleLab_GenericObject_HitPlayer_C::OnBurst(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct FGameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct FGameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct FGameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct FGameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct FGameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct FVector& CallFunc_BreakGameplayCueParameters_Location, const struct FVector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, class UAudioComponent* CallFunc_SpawnSoundAtLocation_ReturnValue)
{
	...
	Params::UGCN_BattleLab_GenericObject_HitPlayer_C_OnBurst_Params Parms{};
