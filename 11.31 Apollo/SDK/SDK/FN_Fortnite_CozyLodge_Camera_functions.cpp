...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "OnActivated");

	Params::AFortnite_CozyLodge_Camera_C_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "OnDeactivated");

	Params::AFortnite_CozyLodge_Camera_C_OnDeactivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "Reset Location");

	Params::AFortnite_CozyLodge_Camera_C_Reset_Location_Params Parms;
...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "ManualActivate");

	Params::AFortnite_CozyLodge_Camera_C_ManualActivate_Params Parms;
...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "K2_OnBecomeViewTarget");
...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "K2_OnEndViewTarget");
...
{
	static auto Func = Class->GetFunction("Fortnite_CozyLodge_Camera_C", "ExecuteUbergraph_Fortnite_CozyLodge_Camera");
