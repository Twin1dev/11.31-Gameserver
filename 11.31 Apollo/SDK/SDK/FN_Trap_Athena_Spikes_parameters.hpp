...
public:
	...
	uint8                                        Pad_5EFB[0xA];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FFortPortableSoftParticles            K2Node_MakeStruct_FortPortableSoftParticles;       // 0x408(0x58)(None)
	...
	uint8                                        Pad_5EFF[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5F00[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UFXSystemAsset*                        Temp_object_Variable_1;                            // 0x4E0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortPortableSoftParticles            K2Node_MakeStruct_FortPortableSoftParticles_1;     // 0x4E8(0x58)(None)
	...
	struct FFortPortableSoftParticles            K2Node_Select_Default_1;                           // 0x580(0x58)(None)
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x5D8(0x10)(ZeroConstructor, NoDestructor)
	struct FFortPortableSoftParticles            K2Node_SetFieldsInStruct_StructOut;                // 0x5E8(0x58)(None)
