...
class UClass* UAthenaDirectAcquisitionOfferWidgetSmall_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaDirectAcquisitionOfferWidgetSmall_C");

	return Clss;
}


// AthenaDirectAcquisitionOfferWidgetSmall_C AthenaDirectAcquisitionOfferWidgetSmall.Default__AthenaDirectAcquisitionOfferWidgetSmall_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaDirectAcquisitionOfferWidgetSmall_C* UAthenaDirectAcquisitionOfferWidgetSmall_C::GetDefaultObj()
{
	static class UAthenaDirectAcquisitionOfferWidgetSmall_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaDirectAcquisitionOfferWidgetSmall_C*>(UAthenaDirectAcquisitionOfferWidgetSmall_C::StaticClass()->DefaultObject);
