...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "ChangeSortFunction");
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "GetWidgetForFramingViewedItem");
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "SetDynamicColors");
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "HandleBack");
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "OnChallengeSetEstablished");
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "Construct");

	Params::UChallengeSetImageGrid_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "BndEvt__MobileCloseButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ChallengeSetImageGrid_C", "ExecuteUbergraph_ChallengeSetImageGrid");
