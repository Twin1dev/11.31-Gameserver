...
// Parameters:
// enum class EUINavigation           Direction                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// UDelegateProperty_                 InCustomDelegate                                                 (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)

void UWidget::SetNavigationRuleCustomBoundary(enum class EUINavigation Direction, UDelegateProperty_ InCustomDelegate)
{
...
void UWidget::SetNavigationRuleCustom(enum class EUINavigation Direction, UDelegateProperty_ InCustomDelegate)
{
