...
public:
	...
	uint8                                        Pad_5A26[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	enum class EGameplayCueEvent                 EventType;                                         // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5A27[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xB8)(BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
};
...
public:
	...
	uint8                                        Pad_5A28[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A29[0x8];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A2A[0xF];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A2B[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A2C[0x8];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A2D[0x2];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A2E[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A2F[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A30[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5A31[0x6];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	class UMaterialInterface*                    CallFunc_GetMaterial_ReturnValue;                  // 0x630(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue_2;                    // 0x638(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5A32[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	struct FVector                               CallFunc_GetCameraLocation_ReturnValue;            // 0x648(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_Subtract_VectorVector_ReturnValue;        // 0x654(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
