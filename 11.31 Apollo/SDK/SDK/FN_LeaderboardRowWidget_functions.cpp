...
{
	static auto Func = Class->GetFunction("LeaderboardRowWidget_C", "BP_OnClicked");

	Params::ULeaderboardRowWidget_C_BP_OnClicked_Params Parms;
...
{
	static auto Func = Class->GetFunction("LeaderboardRowWidget_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("LeaderboardRowWidget_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("LeaderboardRowWidget_C", "BP_OnSelected");

	Params::ULeaderboardRowWidget_C_BP_OnSelected_Params Parms;
...
{
	static auto Func = Class->GetFunction("LeaderboardRowWidget_C", "BP_OnDeselected");

	Params::ULeaderboardRowWidget_C_BP_OnDeselected_Params Parms;
