...
class UClass* AGCN_Loop_GhostMode_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_GhostMode_C");

	return Clss;
}


// GCN_Loop_GhostMode_C GCN_Loop_GhostMode.Default__GCN_Loop_GhostMode_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_GhostMode_C* AGCN_Loop_GhostMode_C::GetDefaultObj()
{
	static class AGCN_Loop_GhostMode_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_GhostMode_C*>(AGCN_Loop_GhostMode_C::StaticClass()->DefaultObject);
