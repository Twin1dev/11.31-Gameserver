...
struct UAthenaMOTDTileMainPage_C_Construct_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_5ADB[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5ADC[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5ADD[0x2];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5ADE[0x6];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5ADF[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5AE0[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5AE1[0x5];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	struct FSlateFontInfo                        K2Node_MakeStruct_SlateFontInfo;                   // 0x318(0x50)(HasGetValueTypeHash)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x368(0x28)()
	struct FTextBlockStyle                       K2Node_MakeStruct_TextBlockStyle;                  // 0x390(0x268)()
};
