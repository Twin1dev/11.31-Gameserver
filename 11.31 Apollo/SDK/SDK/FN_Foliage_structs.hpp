...
public:
	...
	uint8                                        BitPad_2C2 : 7;                                    // Fixing Bit-Field Size  [ Dumper-8 ]
	uint8                                        Pad_415E[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_415F[0x3];                                     // Fixing Size Of Struct [ Dumper-8 ]
};
...
public:
	...
	uint8                                        Pad_4160[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_4161[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_4162[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	class UFoliageType*                          Type;                                              // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4163[0x20];                                    // Fixing Size Of Struct [ Dumper-8 ]
};
