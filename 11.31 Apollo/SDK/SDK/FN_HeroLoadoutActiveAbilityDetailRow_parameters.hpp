...
public:
	...
	uint8                                        Pad_5291[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5293[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           CallFunc_NoResourceBrush_ReturnValue;              // 0x68(0x88)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_ResizedBrush;                 // 0xF0(0x88)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_ResizedBrush_1;               // 0x178(0x88)(None)
	...
	class FText                                  CallFunc_GetCombinedDescription_OutDescription;    // 0x230(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_2;                           // 0x278(0x18)(None)
