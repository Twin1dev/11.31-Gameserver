...
struct UWinterQuestPresentTag_C_PreConstruct_Params
{
public:
...
struct UWinterQuestPresentTag_C_OnSetupCharacterNameTag_Params
{
public:
	struct FLinearColor                          CharacterName;                                     // 0x0(0x10)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x138 (0x138 - 0x0)
// Function WinterQuestPresentTag.WinterQuestPresentTag_C.ExecuteUbergraph_WinterQuestPresentTag
struct UWinterQuestPresentTag_C_ExecuteUbergraph_WinterQuestPresentTag_Params
{
public:
	...
	float                                        Temp_float_Variable_5;                             // 0x50(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_LinearColor_IsNearEqual_ReturnValue;      // 0xB8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_LinearColor_IsNearEqual_ReturnValue_1;    // 0xB9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
