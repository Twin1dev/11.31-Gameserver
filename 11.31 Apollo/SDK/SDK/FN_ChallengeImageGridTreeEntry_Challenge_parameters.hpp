...
public:
	...
	uint8                                        Pad_5C85[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5C86[0x1];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5C87[0x1];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5C88[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	struct FGeometry                             K2Node_Event_MyGeometry;                           // 0x3C(0x38)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_5C89[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5C8A[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_5C8B[0x1];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	int32                                        CallFunc_GetChallengeWeight_ReturnValue;           // 0x168(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_5C8C[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	class FText                                  CallFunc_Conv_IntToText_ReturnValue;               // 0x170(0x18)()
	bool                                         CallFunc_Less_IntInt_ReturnValue;                  // 0x188(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_5C8D[0x7];                                     // Fixing Size After Last Property  [ Dumper-8 ]
