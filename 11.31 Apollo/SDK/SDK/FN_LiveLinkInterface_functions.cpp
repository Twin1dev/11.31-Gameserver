...
class UClass* ULiveLinkBasicFrameInterpolateProcessor::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LiveLinkBasicFrameInterpolateProcessor");

	return Clss;
}


// LiveLinkBasicFrameInterpolateProcessor LiveLinkInterface.Default__LiveLinkBasicFrameInterpolateProcessor
// (Public, ClassDefaultObject, ArchetypeObject)

class ULiveLinkBasicFrameInterpolateProcessor* ULiveLinkBasicFrameInterpolateProcessor::GetDefaultObj()
{
	static class ULiveLinkBasicFrameInterpolateProcessor* Default = nullptr;

	if (!Default)
		Default = static_cast<ULiveLinkBasicFrameInterpolateProcessor*>(ULiveLinkBasicFrameInterpolateProcessor::StaticClass()->DefaultObject);
...
class UClass* ULiveLinkAnimationFrameInterpolateProcessor::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LiveLinkAnimationFrameInterpolateProcessor");

	return Clss;
}


// LiveLinkAnimationFrameInterpolateProcessor LiveLinkInterface.Default__LiveLinkAnimationFrameInterpolateProcessor
// (Public, ClassDefaultObject, ArchetypeObject)

class ULiveLinkAnimationFrameInterpolateProcessor* ULiveLinkAnimationFrameInterpolateProcessor::GetDefaultObj()
{
	static class ULiveLinkAnimationFrameInterpolateProcessor* Default = nullptr;

	if (!Default)
		Default = static_cast<ULiveLinkAnimationFrameInterpolateProcessor*>(ULiveLinkAnimationFrameInterpolateProcessor::StaticClass()->DefaultObject);
...
// LiveLinkAnimationRoleToTransform LiveLinkInterface.Default__LiveLinkAnimationRoleToTransform
// (Public, ClassDefaultObject, ArchetypeObject)
...
class UClass* ULiveLinkAxisSwitchPreProcessor::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LiveLinkAxisSwitchPreProcessor");

	return Clss;
}


// LiveLinkAxisSwitchPreProcessor LiveLinkInterface.Default__LiveLinkAxisSwitchPreProcessor
// (Public, ClassDefaultObject, ArchetypeObject)

class ULiveLinkAxisSwitchPreProcessor* ULiveLinkAxisSwitchPreProcessor::GetDefaultObj()
{
	static class ULiveLinkAxisSwitchPreProcessor* Default = nullptr;

	if (!Default)
		Default = static_cast<ULiveLinkAxisSwitchPreProcessor*>(ULiveLinkAxisSwitchPreProcessor::StaticClass()->DefaultObject);
