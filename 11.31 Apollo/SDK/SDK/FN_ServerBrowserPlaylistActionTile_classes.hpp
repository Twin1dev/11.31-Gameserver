...
class UServerBrowserPlaylistActionTile_C : public UFortPlaylistSelectionActionTile
{
public:
	...
	class UScaleBox*                             Lauch_scalebox;                                    // 0xC60(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	uint8                                        Pad_6700[0x2];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ServerBrowserPlaylistActionTile_C");
		return Clss;
	}
