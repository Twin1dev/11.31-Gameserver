...
public:
	...
	uint8                                        Pad_6EBA[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  K2Node_CustomEvent_SaleText;                       // 0xC8(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_4;                           // 0x150(0x18)(None)
	class FText                                  K2Node_Select_Default_5;                           // 0x168(0x18)(None)
