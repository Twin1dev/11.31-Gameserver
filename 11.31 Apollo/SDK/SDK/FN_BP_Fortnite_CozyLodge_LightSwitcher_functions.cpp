...
class UClass* ABP_Fortnite_CozyLodge_LightSwitcher_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Fortnite_CozyLodge_LightSwitcher_C");

	return Clss;
}


// BP_Fortnite_CozyLodge_LightSwitcher_C BP_Fortnite_CozyLodge_LightSwitcher.Default__BP_Fortnite_CozyLodge_LightSwitcher_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Fortnite_CozyLodge_LightSwitcher_C* ABP_Fortnite_CozyLodge_LightSwitcher_C::GetDefaultObj()
{
	static class ABP_Fortnite_CozyLodge_LightSwitcher_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Fortnite_CozyLodge_LightSwitcher_C*>(ABP_Fortnite_CozyLodge_LightSwitcher_C::StaticClass()->DefaultObject);
...
void ABP_Fortnite_CozyLodge_LightSwitcher_C::SetVisiblityofDetailSpecificMeshes(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, const class FString& CallFunc_GetPlatformName_ReturnValue, bool CallFunc_EqualEqual_StrStr_ReturnValue, bool CallFunc_IsMobilePlatform_ReturnValue, class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, TArray<class ABP_DetailLevelMesh_C*>& CallFunc_GetAllActorsOfClass_OutActors, int32 CallFunc_GetShadowQuality_ReturnValue, class ABP_DetailLevelMesh_C* CallFunc_Array_Get_Item, bool CallFunc_LessEqual_IntInt_ReturnValue, class ABP_DetailLevelMesh_C* K2Node_DynamicCast_AsBP_Detail_Level_Mesh, bool K2Node_DynamicCast_bSuccess, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fortnite_CozyLodge_LightSwitcher_C", "SetVisiblityofDetailSpecificMeshes");

	Params::ABP_Fortnite_CozyLodge_LightSwitcher_C_SetVisiblityofDetailSpecificMeshes_Params Parms{};
...
void ABP_Fortnite_CozyLodge_LightSwitcher_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fortnite_CozyLodge_LightSwitcher_C", "UserConstructionScript");
...
void ABP_Fortnite_CozyLodge_LightSwitcher_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fortnite_CozyLodge_LightSwitcher_C", "ReceiveBeginPlay");
...
void ABP_Fortnite_CozyLodge_LightSwitcher_C::EnableLobbySetLighting()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fortnite_CozyLodge_LightSwitcher_C", "EnableLobbySetLighting");
...
void ABP_Fortnite_CozyLodge_LightSwitcher_C::DisableLobbySetLighting()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fortnite_CozyLodge_LightSwitcher_C", "DisableLobbySetLighting");
...
void ABP_Fortnite_CozyLodge_LightSwitcher_C::UpdateSettings()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fortnite_CozyLodge_LightSwitcher_C", "UpdateSettings");
