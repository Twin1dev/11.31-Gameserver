...
struct UAthenaSeasonBPTrackerWidget_C_FadOutHowToMission_Params
{
public:
...
struct UAthenaSeasonBPTrackerWidget_C_ShowHowToMission_Params
{
public:
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue;                // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_638C[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_638D[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_638E[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
