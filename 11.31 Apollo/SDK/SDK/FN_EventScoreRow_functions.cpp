...
{
	static auto Func = Class->GetFunction("EventScoreRow_C", "SetData");
...
{
	static auto Func = Class->GetFunction("EventScoreRow_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("EventScoreRow_C", "ExecuteUbergraph_EventScoreRow");
