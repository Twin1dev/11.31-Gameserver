...
public:
	...
	uint8                                        Pad_209A[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_209B[0x10];                                    // Fixing Size Of Struct [ Dumper-8 ]
};
...
public:
	...
	class FText                                  FailedLoginAgeVerificationIncomplete;              // 0x228(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FailedLoginParentalLock;                           // 0x240(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FailedLoginNoRealId;                               // 0x258(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FailedLoginLockoutMsg;                             // 0x270(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FailedLoginRequiresMFA;                            // 0x288(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FailedLoginRequiresAuthAppMFA;                     // 0x2A0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FailedInvalidMFA;                                  // 0x2B8(0x18)(Edit, NativeAccessSpecifierPublic)
	...
	class FText                                  FailedStartLogin;                                  // 0x360(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FounderChatExitedText;                             // 0x378(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  FounderChatJoinedText;                             // 0x390(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  GameDisplayName;                                   // 0x3A8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  GeneralLoginFailure;                               // 0x3C0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  GlobalChatExitedText;                              // 0x3D8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  GlobalChatJoinedText;                              // 0x3F0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  HeadlessAccountFailed;                             // 0x408(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  InMatchShutdownTimeWarningText;                    // 0x420(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  InvalidUser;                                       // 0x438(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggedOutofMCP;                                    // 0x450(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  DisconnectedFromMCP;                               // 0x468(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggedOutReturnedToTitle;                          // 0x480(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggedOutSwitchedProfile;                          // 0x498(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggingIn;                                         // 0x4B0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggingInConsoleAuth;                              // 0x4C8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggingOut;                                        // 0x4E0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoginConsole;                                      // 0x4F8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoginFailure;                                      // 0x510(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  Logout_Unlink;                                     // 0x528(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LogoutCompleted;                                   // 0x540(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LostConnection;                                    // 0x558(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  MCPTimeout;                                        // 0x570(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LightswitchCheckNetworkFailureMsg;                 // 0x588(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  NetworkConnectionUnavailable;                      // 0x5A0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  NoPlayEntitlement;                                 // 0x5B8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  NoServerAccess;                                    // 0x5D0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PlayAccessRevoked;                                 // 0x5E8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PremiumAccountName_Default;                        // 0x600(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PremiumAccountName_PS4;                            // 0x618(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PremiumAccountName_Switch;                         // 0x630(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  PremiumAccountName_XboxOne;                        // 0x648(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  RedeemOfflinePurchases;                            // 0x660(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ServiceDowntime;                                   // 0x678(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  SignInCompleting;                                  // 0x690(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  SignIntoConsoleServices;                           // 0x6A8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  TokenExpired;                                      // 0x6C0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UnableToConnect;                                   // 0x6D8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UnableToJoinWaitingRoomLoginQueue;                 // 0x6F0(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UnexpectedConsoleAuthFailure;                      // 0x708(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UnlinkConsoleFailed;                               // 0x720(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UserLoginFailed;                                   // 0x738(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  WaitingRoom;                                       // 0x750(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  WaitingRoomError;                                  // 0x768(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  WaitingRoomFailure;                                // 0x780(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  WaitingRoomWaiting;                                // 0x798(0x18)(Edit, NativeAccessSpecifierPublic)
	struct FOnlineAccountTexts_FailedLoginConsole FailedLoginConsole;                                // 0x7B0(0x138)(Edit, NativeAccessSpecifierPublic)
	class FText                                  LoggingInExternalAuth;                             // 0x8E8(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  CreateDeviceAuth;                                  // 0x900(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthCanceled;                                   // 0x918(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthFailure;                                    // 0x930(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthAssociationFailure;                         // 0x948(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthTimeout;                                    // 0x960(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  ExtAuthMissingAuthAssociation;                     // 0x978(0x18)(Edit, NativeAccessSpecifierPublic)
	class FText                                  UnableToQueryReceipts;                             // 0x990(0x18)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
