...
public:
	...
	struct FWeightedBlendables                   K2Node_MakeStruct_WeightedBlendables;              // 0x50(0x10)(None)
	...
	struct FWeightedBlendables                   K2Node_MakeStruct_WeightedBlendables_1;            // 0x90(0x10)(None)
	...
	uint8                                        Pad_44DC[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FUnderwaterPostProcessSettings        K2Node_MakeStruct_UnderwaterPostProcessSettings;   // 0xF0(0x540)(None)
	...
	struct FUnderwaterPostProcessSettings        K2Node_MakeStruct_UnderwaterPostProcessSettings_1; // 0x670(0x540)(None)
