...
class UClass* UGC_Athena_Feedback_ExplosionSmall_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Athena_Feedback_ExplosionSmall_C");

	return Clss;
}


// GC_Athena_Feedback_ExplosionSmall_C GC_Athena_Feedback_ExplosionSmall.Default__GC_Athena_Feedback_ExplosionSmall_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGC_Athena_Feedback_ExplosionSmall_C* UGC_Athena_Feedback_ExplosionSmall_C::GetDefaultObj()
{
	static class UGC_Athena_Feedback_ExplosionSmall_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGC_Athena_Feedback_ExplosionSmall_C*>(UGC_Athena_Feedback_ExplosionSmall_C::StaticClass()->DefaultObject);
