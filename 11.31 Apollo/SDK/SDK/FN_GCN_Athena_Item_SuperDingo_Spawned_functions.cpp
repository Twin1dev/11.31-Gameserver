...
class UClass* UGCN_Athena_Item_SuperDingo_Spawned_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_Item_SuperDingo_Spawned_C");

	return Clss;
}


// GCN_Athena_Item_SuperDingo_Spawned_C GCN_Athena_Item_SuperDingo_Spawned.Default__GCN_Athena_Item_SuperDingo_Spawned_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_Item_SuperDingo_Spawned_C* UGCN_Athena_Item_SuperDingo_Spawned_C::GetDefaultObj()
{
	static class UGCN_Athena_Item_SuperDingo_Spawned_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_Item_SuperDingo_Spawned_C*>(UGCN_Athena_Item_SuperDingo_Spawned_C::StaticClass()->DefaultObject);
...
void UGCN_Athena_Item_SuperDingo_Spawned_C::OnBurst(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance, class UParticleSystemComponent* CallFunc_Array_Get_Item, class ABGA_Athena_SuperDingo_C* K2Node_DynamicCast_AsBGA_Athena_Super_Dingo, bool K2Node_DynamicCast_bSuccess, bool CallFunc_K2_AttachToComponent_ReturnValue)
{
	...
	Params::UGCN_Athena_Item_SuperDingo_Spawned_C_OnBurst_Params Parms{};
