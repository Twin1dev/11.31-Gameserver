...
{
	static auto Func = Class->GetFunction("SafeZoneIndicator_C", "GetRandomPointInPlayerDir");
...
{
	static auto Func = Class->GetFunction("SafeZoneIndicator_C", "GetRandomPointOnBoundary");
...
{
	static auto Func = Class->GetFunction("SafeZoneIndicator_C", "Play Storm Grow Audio");

	Params::ASafeZoneIndicator_C_Play_Storm_Grow_Audio_Params Parms;
...
{
	static auto Func = Class->GetFunction("SafeZoneIndicator_C", "Trigger Distant Storm Oneshot");

	Params::ASafeZoneIndicator_C_Trigger_Distant_Storm_Oneshot_Params Parms;
...
{
	static auto Func = Class->GetFunction("SafeZoneIndicator_C", "Stop Distant Storm Oneshots");

	Params::ASafeZoneIndicator_C_Stop_Distant_Storm_Oneshots_Params Parms;
