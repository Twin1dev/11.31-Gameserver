...
public:
	...
	void Construct();
	void ExecuteUbergraph_CMS_ML_BattlePass_RightImageWidget(int32 EntryPoint, class UAthenaAccountContext* CallFunc_GetContext_ReturnValue, class FText CallFunc_GetCurrentChapterAndSeasonText_ReturnValue);
};
