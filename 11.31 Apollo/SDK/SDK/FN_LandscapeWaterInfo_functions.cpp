...
// struct FUnderwaterPostProcessSettingsK2Node_MakeStruct_UnderwaterPostProcessSettings                  ()
...
// struct FUnderwaterPostProcessSettingsK2Node_MakeStruct_UnderwaterPostProcessSettings_1                ()
...
{
	static auto Func = Class->GetFunction("LandscapeWaterInfo_C", "Apply PostProcess MID to WaterBodies");
...
{
	static auto Func = Class->GetFunction("LandscapeWaterInfo_C", "Update Water MID");
...
{
	static auto Func = Class->GetFunction("LandscapeWaterInfo_C", "Set Water MPC Values");
...
{
	static auto Func = Class->GetFunction("LandscapeWaterInfo_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("LandscapeWaterInfo_C", "ReceiveEndPlay");
