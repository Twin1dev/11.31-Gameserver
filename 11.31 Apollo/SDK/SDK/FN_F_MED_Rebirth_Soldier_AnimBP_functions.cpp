...
{
	static auto Func = Class->GetFunction("F_MED_Rebirth_Soldier_AnimBP_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("F_MED_Rebirth_Soldier_AnimBP_C", "ExecuteUbergraph_F_MED_Rebirth_Soldier_AnimBP");
