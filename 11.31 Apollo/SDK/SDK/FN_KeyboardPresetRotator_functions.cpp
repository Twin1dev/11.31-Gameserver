...
{
	static auto Func = Class->GetFunction("KeyboardPresetRotator_C", "Update Size");
...
{
	static auto Func = Class->GetFunction("KeyboardPresetRotator_C", "BndEvt__TextRotator_K2Node_ComponentBoundEvent_5_OnRotated__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("KeyboardPresetRotator_C", "BndEvt__ButtonLeft_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("KeyboardPresetRotator_C", "BndEvt__ButtonRight_K2Node_ComponentBoundEvent_15_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("KeyboardPresetRotator_C", "PreConstruct");
