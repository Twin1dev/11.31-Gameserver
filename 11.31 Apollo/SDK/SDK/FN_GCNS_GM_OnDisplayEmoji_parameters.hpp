...
public:
	...
	uint8                                        Pad_4985[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_4986[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	struct FHitResult                            CallFunc_K2_SetRelativeLocation_SweepHitResult;    // 0x1A0(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                               CallFunc_Random_360_VectorInRange_Random_Vector_Result_; // 0x238(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_Add_FloatFloat_ReturnValue_2;             // 0x254(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_MakeVector_ReturnValue_1;                 // 0x258(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
