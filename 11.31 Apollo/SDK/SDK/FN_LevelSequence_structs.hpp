...
{
public:
	uint8                                        Pad_1CA5[0x1];                                     // Fixing Size Of Struct [ Dumper-8 ]
};
...
{
public:
	uint8                                        Pad_1CA6[0x50];                                    // Fixing Size Of Struct [ Dumper-8 ]
};
...
{
public:
	uint8                                        Pad_1CA7[0x20];                                    // Fixing Size Of Struct [ Dumper-8 ]
};
...
public:
	...
	uint8                                        Pad_1CA8[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1CA9[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1CAA[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1CAB[0x4];                                     // Fixing Size Of Struct [ Dumper-8 ]
};
