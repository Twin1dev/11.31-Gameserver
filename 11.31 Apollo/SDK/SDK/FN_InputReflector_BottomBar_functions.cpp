...
{
	static auto Func = Class->GetFunction("InputReflector_BottomBar_C", "StyleButton");
...
{
	static auto Func = Class->GetFunction("InputReflector_BottomBar_C", "HandleAddButton");
...
{
	static auto Func = Class->GetFunction("InputReflector_BottomBar_C", "OnButtonAdded");
...
{
	static auto Func = Class->GetFunction("InputReflector_BottomBar_C", "ExecuteUbergraph_InputReflector_BottomBar");
