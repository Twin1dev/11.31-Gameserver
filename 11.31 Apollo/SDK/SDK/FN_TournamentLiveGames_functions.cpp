...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "BndEvt__BackButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "Init");
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "EventColorize");
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "NotifyNoLiveGames");

	Params::UTournamentLiveGames_C_NotifyNoLiveGames_Params Parms;
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "NotifyLoadingMoreGames");
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "HandleViewLiveGames");

	Params::UTournamentLiveGames_C_HandleViewLiveGames_Params Parms;
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "ExecuteUbergraph_TournamentLiveGames");
...
{
	static auto Func = Class->GetFunction("TournamentLiveGames_C", "CallEventLiveGamesBack__DelegateSignature");

	Params::UTournamentLiveGames_C_CallEventLiveGamesBack__DelegateSignature_Params Parms;
