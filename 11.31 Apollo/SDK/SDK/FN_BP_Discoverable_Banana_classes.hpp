...
public:
	...
	uint8                                        Pad_4879[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_487A[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_487B[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BP_Discoverable_Banana_C");
		return Clss;
	}
