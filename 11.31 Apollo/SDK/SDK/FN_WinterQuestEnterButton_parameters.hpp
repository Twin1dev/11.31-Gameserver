...
struct UWinterQuestEnterButton_C_BP_OnHovered_Params
{
public:
};
...
struct UWinterQuestEnterButton_C_BP_OnUnhovered_Params
{
public:
};
...
struct UWinterQuestEnterButton_C_ExecuteUbergraph_WinterQuestEnterButton_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_52E6[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
