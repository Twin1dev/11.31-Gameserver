...
class UWinterQuest_ShakeIOSPrompt_C : public UFortWinterQuestButton
{
public:
	...
	class UImage*                                IOSShakeButtonBacking;                             // 0xBD8(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UImage*                                PointerArrow_Left;                                 // 0xBE0(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("WinterQuest_ShakeIOSPrompt_C");
		return Clss;
	}
