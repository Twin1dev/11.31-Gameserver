...
public:
	...
	uint8                                        Pad_6340[0x1];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_6341[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_6342[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	struct FGeometry                             K2Node_Event_MyGeometry;                           // 0x34(0x38)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_6343[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	bool                                         K2Node_Event_bCompact;                             // 0x153(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_Event_HideRewards;                          // 0x154(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6344[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	float                                        K2Node_Select_Default_1;                           // 0x158(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
