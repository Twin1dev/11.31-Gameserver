...
{
	static auto Func = Class->GetFunction("GA_Athena_FlopperSmall_C", "K2_CommitExecute");

	Params::UGA_Athena_FlopperSmall_C_K2_CommitExecute_Params Parms;
...
{
	static auto Func = Class->GetFunction("GA_Athena_FlopperSmall_C", "ExecuteUbergraph_GA_Athena_FlopperSmall");
