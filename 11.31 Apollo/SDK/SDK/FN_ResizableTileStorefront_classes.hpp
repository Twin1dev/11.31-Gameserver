...
class UResizableTileStorefront_C : public UAthenaItemShopSection_Storefront
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ResizableTileStorefront_C");
		return Clss;
	}

	void OnSectionEstablished(bool bEmptySection);
	void ExecuteUbergraph_ResizableTileStorefront(int32 EntryPoint, bool K2Node_Event_bEmptySection, bool Temp_bool_Variable, class UWidget* K2Node_Select_Default);
};
