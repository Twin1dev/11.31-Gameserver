...
class UClass* AB_Prj_Athena_GiftBox_Green_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_Athena_GiftBox_Green_C");

	return Clss;
}


// B_Prj_Athena_GiftBox_Green_C B_Prj_Athena_GiftBox_Green.Default__B_Prj_Athena_GiftBox_Green_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_Athena_GiftBox_Green_C* AB_Prj_Athena_GiftBox_Green_C::GetDefaultObj()
{
	static class AB_Prj_Athena_GiftBox_Green_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_Athena_GiftBox_Green_C*>(AB_Prj_Athena_GiftBox_Green_C::StaticClass()->DefaultObject);
...
void AB_Prj_Athena_GiftBox_Green_C::ClearOnly(TArray<struct FVector>& ClearedGridCells, bool DestroyFloorsQuickly, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Array_Length_ReturnValue, const struct FVector& CallFunc_Array_Get_Item, int32 Temp_int_Loop_Counter_Variable, class UBuildingStructuralSupportSystem* CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class UBuildingStructuralSupportSystem* CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem_1, float CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, const struct FVector& CallFunc_RotateAngleAxis_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "ClearOnly");

	Params::AB_Prj_Athena_GiftBox_Green_C_ClearOnly_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::CallDynamicBuilder(class UClass* Class, const struct FVector& Location, class AController* CallFunc_GetInstigatorController_ReturnValue, float CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class AActor* CallFunc_FinishSpawningActor_ReturnValue, class ABuildingActor* K2Node_DynamicCast_AsBuilding_Actor, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "CallDynamicBuilder");

	Params::AB_Prj_Athena_GiftBox_Green_C_CallDynamicBuilder_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::CalculateCardinalDirection(class APawn* CallFunc_GetInstigator_ReturnValue, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_Abs_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, float CallFunc_Abs_ReturnValue_1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue_1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue_2)
{
	...
	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "CalculateCardinalDirection");

	Params::AB_Prj_Athena_GiftBox_Green_C_CalculateCardinalDirection_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::HandleProps(TArray<class AActor*>& Array, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, int32 Temp_int_Array_Index_Variable, bool CallFunc_Less_IntInt_ReturnValue, class AActor* CallFunc_Array_Get_Item, int32 CallFunc_Array_Add_ReturnValue, int32 CallFunc_Array_Add_ReturnValue_1, class ABuildingPropBigHealth* K2Node_DynamicCast_AsBuilding_Prop_Big_Health, bool K2Node_DynamicCast_bSuccess, class ATiered_Chest_Athena_C* K2Node_DynamicCast_AsTiered_Chest_Athena, bool K2Node_DynamicCast_bSuccess_1, class ABuildingActor* K2Node_DynamicCast_AsBuilding_Actor, bool K2Node_DynamicCast_bSuccess_2, class ABP_DamageBalloon_Athena_C* K2Node_DynamicCast_AsBP_Damage_Balloon_Athena, bool K2Node_DynamicCast_bSuccess_3, class ABuildingProp* K2Node_DynamicCast_AsBuilding_Prop, bool K2Node_DynamicCast_bSuccess_4, int32 CallFunc_Add_IntInt_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "HandleProps");

	Params::AB_Prj_Athena_GiftBox_Green_C_HandleProps_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::ClearAndBuild(TArray<struct FVector>& ClearedGridCells, TArray<class UClass*>& BGAClassArray, TArray<struct FVector>& BGALocationArray, TArray<struct FRotator>& BGARotationArray, bool DestroyFloorsQuickly, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, class UBuildingStructuralSupportSystem* CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem, const struct FVector& CallFunc_Array_Get_Item, float CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, const struct FVector& CallFunc_RotateAngleAxis_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "ClearAndBuild");

	Params::AB_Prj_Athena_GiftBox_Green_C_ClearAndBuild_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::CreateBaseSection(const struct FVector& ReferenceLocation, TArray<class UClass*>& BGAClassArray, TArray<struct FVector>& BGALocationArray, TArray<struct FRotator>& BGARotationArray, class UBuildingStructuralSupportSystem* CallFunc_GetBuildingStructuralSupportSystem_BuildingStructuralSupportSystem, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, const struct FVector& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, float CallFunc_Map_Find_Value_1, bool CallFunc_Map_Find_ReturnValue_1, uint8 CallFunc_GetActorTeam_ReturnValue, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class UClass* CallFunc_Array_Get_Item, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, const struct FVector& CallFunc_RotateAngleAxis_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_1, const struct FTransform& CallFunc_MakeTransform_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class AActor* CallFunc_FinishSpawningActor_ReturnValue, class ABuildingSMActor* K2Node_DynamicCast_AsBuilding_SMActor, bool K2Node_DynamicCast_bSuccess, class ABuildingTrap* K2Node_DynamicCast_AsBuilding_Trap, bool K2Node_DynamicCast_bSuccess_1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_2, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_3, bool CallFunc_IsWorldLocValid_ReturnValue, bool CallFunc_IsWorldLocValid_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "CreateBaseSection");

	Params::AB_Prj_Athena_GiftBox_Green_C_CreateBaseSection_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::SetBaseDestination(struct FHitResult& Hit, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_GridSnap_Float_ReturnValue, float CallFunc_Subtract_FloatFloat_ReturnValue, float CallFunc_GridSnap_Float_ReturnValue_1, float CallFunc_GridSnap_Float_ReturnValue_2, float CallFunc_Subtract_FloatFloat_ReturnValue_1, const struct FVector& CallFunc_MakeVector_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "SetBaseDestination");

	Params::AB_Prj_Athena_GiftBox_Green_C_SetBaseDestination_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::UserConstructionScript(bool CallFunc_IsDedicatedServer_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "UserConstructionScript");

	Params::AB_Prj_Athena_GiftBox_Green_C_UserConstructionScript_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::OnStop(struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "OnStop");

	Params::AB_Prj_Athena_GiftBox_Green_C_OnStop_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::OnExploded(TArray<class AActor*>& HitActors, TArray<struct FHitResult>& HitResults)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "OnExploded");

	Params::AB_Prj_Athena_GiftBox_Green_C_OnExploded_Params Parms{};
...
void AB_Prj_Athena_GiftBox_Green_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "ReceiveHit");

	Params::AB_Prj_Athena_GiftBox_Green_C_ReceiveHit_Params Parms{};
...
// Function B_Prj_Athena_GiftBox_Green.B_Prj_Athena_GiftBox_Green_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AB_Prj_Athena_GiftBox_Green_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "ReceiveBeginPlay");
...
void AB_Prj_Athena_GiftBox_Green_C::Handle_Bounce(const struct FVector& Hit_Location)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "Handle Bounce");

	Params::AB_Prj_Athena_GiftBox_Green_C_Handle_Bounce_Params Parms{};
...
// Function B_Prj_Athena_GiftBox_Green.B_Prj_Athena_GiftBox_Green_C.Delete another actor
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AB_Prj_Athena_GiftBox_Green_C::Delete_another_actor()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "Delete another actor");
...
void AB_Prj_Athena_GiftBox_Green_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "ReceiveEndPlay");

	Params::AB_Prj_Athena_GiftBox_Green_C_ReceiveEndPlay_Params Parms{};
...
// Function B_Prj_Athena_GiftBox_Green.B_Prj_Athena_GiftBox_Green_C.OnBeginPlayQuestCheck
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AB_Prj_Athena_GiftBox_Green_C::OnBeginPlayQuestCheck()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "OnBeginPlayQuestCheck");
...
// Function B_Prj_Athena_GiftBox_Green.B_Prj_Athena_GiftBox_Green_C.Play Quest Success FX
// (Net, NetMulticast, BlueprintCallable, BlueprintEvent)
// Parameters:

void AB_Prj_Athena_GiftBox_Green_C::Play_Quest_Success_FX()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("B_Prj_Athena_GiftBox_Green_C", "Play Quest Success FX");
