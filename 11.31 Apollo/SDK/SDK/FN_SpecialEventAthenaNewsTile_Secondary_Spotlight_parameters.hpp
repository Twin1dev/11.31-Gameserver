...
struct USpecialEventAthenaNewsTile_Secondary_Spotlight_C_PlayIntroAnim_Params
{
public:
};
...
struct USpecialEventAthenaNewsTile_Secondary_Spotlight_C_SetDefaultImage_Params
{
public:
};
...
struct USpecialEventAthenaNewsTile_Secondary_Spotlight_C_ExecuteUbergraph_SpecialEventAthenaNewsTile_Secondary_Spotlight_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_52E3[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
