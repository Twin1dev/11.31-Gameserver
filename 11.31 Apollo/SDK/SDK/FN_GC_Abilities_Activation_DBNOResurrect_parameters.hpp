...
public:
	...
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue;                 // 0x1BC(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x1C8(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
