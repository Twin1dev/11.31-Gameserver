...
class UClass* AGCN_Loop_Hot_Feet_Environmental_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_Hot_Feet_Environmental_C");

	return Clss;
}


// GCN_Loop_Hot_Feet_Environmental_C GCN_Loop_Hot_Feet_Environmental.Default__GCN_Loop_Hot_Feet_Environmental_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_Hot_Feet_Environmental_C* AGCN_Loop_Hot_Feet_Environmental_C::GetDefaultObj()
{
	static class AGCN_Loop_Hot_Feet_Environmental_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_Hot_Feet_Environmental_C*>(AGCN_Loop_Hot_Feet_Environmental_C::StaticClass()->DefaultObject);
...
void AGCN_Loop_Hot_Feet_Environmental_C::OnRemoval(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class UCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static class UFunction* Func = nullptr;
