...
public:
	...
	uint8                                        Pad_68D5[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateColor                           K2Node_Select_Default_1;                           // 0x208(0x28)(None)
	...
	class FText                                  CallFunc_GetEventDateAsText_ReturnValue;           // 0x248(0x18)(None)
	...
	class FText                                  CallFunc_GetEventDateAsText_ReturnValue_1;         // 0x278(0x18)(None)
	...
	class FText                                  CallFunc_GetEventTimeAsText_ReturnValue;           // 0x2A0(0x18)(None)
	...
	class FText                                  CallFunc_GetEventTimeAsText_ReturnValue_1;         // 0x300(0x18)(None)
	...
	class FText                                  CallFunc_GetEventDateAsText_ReturnValue_2;         // 0x360(0x18)(None)
	...
	class FText                                  CallFunc_GetEventDateAsText_ReturnValue_3;         // 0x3C0(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_4;                           // 0x450(0x18)(None)
