...
{
	static auto Func = Class->GetFunction("AthenaMOTDWidget_C", "SetTextIfValidOrDefault");
...
{
	static auto Func = Class->GetFunction("AthenaMOTDWidget_C", "OnInitialized");

	Params::UAthenaMOTDWidget_C_OnInitialized_Params Parms;
