...
{
public:
	uint8                                        Pad_1A50[0x8];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        BitPad_174 : 2;                                    // Fixing Bit-Field Size  [ Dumper-8 ]
	uint8                                        Pad_1A51[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        BitPad_175 : 7;                                    // Fixing Bit-Field Size  [ Dumper-8 ]
	uint8                                        Pad_1A52[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	float                                        Mass;                                              // 0x148(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1A53[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A54[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A55[0x18];                                    // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A56[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A57[0x24];                                    // Fixing Size After Last Property  [ Dumper-8 ]
...
{
public:
	uint8                                        Pad_1A5A[0x700];                                   // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A5B[0x8];                                     // Fixing Size Of Struct [ Dumper-8 ]
...
public:
	...
	uint8                                        Pad_1A5C[0x2];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A5D[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A5E[0x3];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A5F[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A60[0x4];                                     // Fixing Size After Last Property  [ Dumper-8 ]
	...
	uint8                                        Pad_1A61[0xC];                                     // Fixing Size Of Struct [ Dumper-8 ]
