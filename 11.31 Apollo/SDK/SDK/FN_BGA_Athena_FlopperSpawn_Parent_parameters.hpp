...
public:
	...
	uint8                                        Pad_5721[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortItemEntry                        CallFunc_Array_Get_Item;                           // 0x50(0x120)(None)
	...
	struct FGameplayTagContainer                 CallFunc_GetPoiGridTagsForLocation_ReturnValue;    // 0x1A8(0x20)(None)
	...
	struct FGameplayTagContainer                 Temp_struct_Variable;                              // 0x348(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_Select_Default_1;                           // 0x3A8(0x20)(None)
