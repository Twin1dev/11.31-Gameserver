...
public:
	...
	struct FAnimNode_Root                        AnimGraphNode_Root_6FDF76E049A24B1EF9D7DEBBD91751CF; // 0xB258(0x30)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_647109C14F48E941AEF9E486BCFFCB5B; // 0xB288(0x20)(None)
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_59E069244645BEF22808AB9196186F3F; // 0xB2A8(0x108)(None)
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_32956B0E479193012ACF3FB15ECAFEE6; // 0xB3B0(0x108)(None)
	struct FAnimNode_SequencePlayer              AnimGraphNode_SequencePlayer_80446D5E4D39FC4DB897698A65CD29AC; // 0xB4B8(0x78)(None)
	struct FAnimNode_ApplyAdditive               AnimGraphNode_ApplyAdditive_56B19EE040BEEBC25D674F8DC99831B9; // 0xB530(0xC8)(None)
	uint8                                        Pad_4F71[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_TwoBoneIK                   AnimGraphNode_TwoBoneIK_A2B587A34E6D45FD2755F6A163B2A7AD; // 0xB600(0x1E0)(None)
	...
	struct FAnimNode_LinkedAnimGraph             AnimGraphNode_SubInstance_BC9172D64300E6A13C48509FE2988A40; // 0xB7E8(0x90)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_2362F79B4764FBA8C8FEEDA5DC88C3B1; // 0xB878(0x20)(None)
	struct FAnimNode_TransitionResult            AnimGraphNode_TransitionResult_AC1F897843DFD7A8178B8A82E3A790EE; // 0xB898(0x28)(None)
	struct FAnimNode_TransitionResult            AnimGraphNode_TransitionResult_2DF19C19483B180CCD9B0395F0443067; // 0xB8C0(0x28)(None)
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator_78D4698F4DBD0C20473F7A9407EBB46C; // 0xB8E8(0x48)(None)
	struct FAnimNode_StateResult                 AnimGraphNode_StateResult_A08B893F416A2C075FC4E584C74BAC5C; // 0xB930(0x30)(None)
	struct FAnimNode_SequencePlayer              AnimGraphNode_SequencePlayer_339D53304C96E6E9CA54849FD42463D2; // 0xB960(0x78)(None)
	struct FAnimNode_StateResult                 AnimGraphNode_StateResult_2845F0614F1F506F5C75FEB6DB44688C; // 0xB9D8(0x30)(None)
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator_F7E4CA4748A4826364AE6EAADE5CBA3C; // 0xBA08(0x48)(None)
	struct FAnimNode_StateResult                 AnimGraphNode_StateResult_0DF022F34E2D19939A036B970D6F6AFA; // 0xBA50(0x30)(None)
	struct FAnimNode_StateMachine                AnimGraphNode_StateMachine_928ECAB14B37D35EE66BE6A15B810F70; // 0xBA80(0xB0)(None)
	struct FAnimNode_TwoWayBlend                 AnimGraphNode_TwoWayBlend_AA9C546E4B1C5BEF0332B08ECB6BFC83; // 0xBB30(0xC8)(None)
	struct FAnimNode_SaveCachedPose              AnimGraphNode_SaveCachedPose_DB53A2DF4CAE9120C146E49AC957D990; // 0xBBF8(0xB8)(None)
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose_88EB1D724EB384A84A32F184D445B4B9; // 0xBCB0(0x28)(None)
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose_0634F0B8457CE9932959C29729FE76F9; // 0xBCD8(0x28)(None)
