...
{
public:
	uint8                                        Pad_EA5[0x1B8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_EA9[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EAD[0x2E];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_EAE[0x16];                                     // Fixing Size After Last Property  [ Dumper-7 ]
