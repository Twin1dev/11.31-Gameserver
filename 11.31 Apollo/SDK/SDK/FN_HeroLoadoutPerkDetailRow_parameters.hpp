...
public:
	...
	uint8                                        Pad_6C76[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6C83[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           CallFunc_NoResourceBrush_ReturnValue;              // 0x88(0x88)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_ResizedBrush;                 // 0x110(0x88)(None)
	struct FSlateBrush                           CallFunc_ResizeBrush_ResizedBrush_1;               // 0x198(0x88)(None)
	...
	class FText                                  CallFunc_GetCombinedDescription_OutDescription;    // 0x250(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_1;                           // 0x288(0x18)(None)
	class FText                                  CallFunc_GetCombinedDescription_OutDescription_1;  // 0x2A0(0x18)(None)
...
public:
	...
	bool                                         Temp_bool_Variable_1;                              // 0x3(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6C89[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
